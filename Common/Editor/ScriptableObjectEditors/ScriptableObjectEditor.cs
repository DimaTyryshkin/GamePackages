...
namespace GamePackages.Core.ScriptableObjectEditors.Editor
{
    ...
    /// Окошки у всех редакторов одинаковые и вынесены в класс <see cref="ScriptableObjectEditorWindow{AssetT,EditorT,WindowT}"/>, 
    /// а уникальная логика самого редактора пишется в наследниках этого класса.
    /// Во вторых тут запилен функционал который правильно создает/удаялет вложенные ассеты. Это когда  ScriptableObject содержит в себе другие ScriptableObject
    /// </summary> 
